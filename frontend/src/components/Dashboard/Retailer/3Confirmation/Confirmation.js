...
const Confirmation = (props) => {
    return (
        <div style={{ backgroundColor:'#0000CC',padding:'20px'}}>
            <center>
                <Card style={{ width: '48rem', backgroundColor: '#196DFD' }}><Card.Body>
...
Final Price : {props.location.bookingInfo.finalPrice} <br />
                    ...
                    <Button style={{ backgroundColor: '#fff',color:'#0341AC'}} ><Link to='/retailDashboard/paymentsGateway' style={{ color: '#0341AC' }} onClick={confirmBookingAtServer}>Confirm PreOrder</Link></Button>
