...
const PreOrderCard = (props) => {
    ...
    return (
        <div style={{ backgroundColor:'#0000CC'}}>
            <Card style={{ width: '18rem', backgroundColor: '#196DFD', margin: 25 }}>
                <Card.Body>
                    ...
                    <Card.Text style={{ color: '#ad0000', fontWeight: "bold" }}>
                        PreOrdered by above Retailer
                    </Card.Text>
                    <Card.Footer style={{ backgroundColor:'#0000CC',color:'#fff'}}>  Booked Quantity : {props.bookingData.selectedQuantity} <br />
